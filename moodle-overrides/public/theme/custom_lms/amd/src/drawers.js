 ...
 *
 * @module     theme_custom_lms/drawers
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_custom_lms/drawers:show}
     * @property {String} drawerShown See {@link event:theme_custom_lms/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_custom_lms/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_custom_lms/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_custom_lms/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_custom_lms/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_custom_lms/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_custom_lms/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_custom_lms/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_custom_lms/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_custom_lms/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_custom_lms/drawers:hidden',
    };
     ...
     * @returns {module:theme_custom_lms/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true, setUserPref = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_custom_lms/drawers:open');
     ...
     */
        ...
        const pendingPromise = new Pending('theme_custom_lms/drawers:close');
     ...
     *
     * @param {module:theme_custom_lms/drawers} comparisonInstance
     */

...
* remove folder theme/custom_lms/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/custom_lms/scss/bootstrap
...
* remove folder theme/custom_lms/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/custom_lms/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/custom_lms/amd/src
* edit theme/custom_lms/amd/src/index.js and update import path (src -> bootstrap)
...
* in folder theme/custom_lms run "grunt amd" to compile the bootstrap JS
* in folder theme/custom_lms run "grunt css" to compile scss

...
2. SCSS:
  a. Replace the files in this folder (/theme/custom_lms/scss/fontawesome) with the files in the scss folder.
  b. Copy the LICENSE.txt file from the root to theme/custom_lms/scss/fontawesome.
  c. Update theme/custom_lms/thirdpartylibs.xml.

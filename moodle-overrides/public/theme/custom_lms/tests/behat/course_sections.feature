@theme_custom_lms
Feature: Course sections selector is not available on custom_lms theme
  ...
  Scenario Outline: Course sections selector is not available on custom_lms theme regardless of the course format

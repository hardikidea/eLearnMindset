...
/**
 * A login page layout for the custom_lms theme.
 *
...
$bodyattributes = $OUTPUT->body_attributes(['custom-lms-role-public']);
...
echo $OUTPUT->render_from_template('theme_custom_lms/login', $templatecontext);

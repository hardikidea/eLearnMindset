...
final class scss_test extends \advanced_testcase {
    /**
     * Test that admin_theme can be compiled using SassC (the defacto implemention).
     */
    public function test_scss_compilation_with_sassc(): void {
        ...
        $this->assertNotEmpty(
            \theme_config::load('admin_theme')->get_css_content_debug('scss', null, null)
        );
    }
}

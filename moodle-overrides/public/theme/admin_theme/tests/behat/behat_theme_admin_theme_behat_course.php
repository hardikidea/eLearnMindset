...
/**
 * Behat course-related step definition overrides for the Admin Theme theme.
 *
...
/**
 * Course-related step definition overrides for the Admin Theme theme.
 *
 * @package    theme_admin_theme
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_admin_theme_behat_course extends behat_course {

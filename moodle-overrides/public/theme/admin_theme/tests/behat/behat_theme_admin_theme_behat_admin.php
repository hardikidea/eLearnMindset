...
/**
 * Step definitions related to administration overrides for the Admin Theme theme.
 *
...
/**
 * Site administration level steps definitions overrides for the Admin Theme theme.
 *
 * @package    theme_admin_theme
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_admin_theme_behat_admin extends behat_admin {

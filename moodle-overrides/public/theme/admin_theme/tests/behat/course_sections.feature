@theme_admin_theme
Feature: Select course sections using admin_theme theme
  In order to view course sections when using the admin_theme theme
  As a teacher
  ...
  @javascript
  Scenario: Use the course section selector in admin_theme theme

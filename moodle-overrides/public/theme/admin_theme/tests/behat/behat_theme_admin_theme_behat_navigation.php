...
/**
 * Navigation step definition overrides for the Admin Theme theme.
 *
...
/**
 * Step definitions and overrides to navigate through the navigation tree nodes in the Admin Theme theme.
 *
 * @package    theme_admin_theme
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_admin_theme_behat_navigation extends behat_navigation {
    /**
    ...
    public function menu_item_should_be_active(string $navigationmenuitem): void {
        throw new DriverException(
            'The Admin Theme theme does not implement navigation in a way that allows this step to be used.',
        );
    }
    ...
    public function menu_item_should_not_be_active(string $navigationmenuitem): void {
        throw new DriverException(
            'The Admin Theme theme does not implement the navigation in a way that allows this step to be used.',
        );
    }
}

...
/**
 * Override definitions for the upload repository type for the Admin Theme theme.
 *
...
/**
 * Override step definitions to deal with the upload repository in the Admin Theme theme.
 *
 * @package    theme_admin_theme
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_admin_theme_behat_repository_upload extends behat_repository_upload {

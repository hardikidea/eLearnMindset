...
if ($isfrontpage && !empty($primarymenu['moremenu'])) {
    $primarymenu['moremenu']['nodearray'] = array_merge($primarymenu['moremenu']['nodearray'] ?? [], [
        [
            'key' => 'boc-fragment-discover',
            'text' => 'Discover',
            'title' => 'Discover',
            'url' => '',
            'action' => '#discover',
        ...
        [
            'key' => 'boc-fragment-boards',
            'text' => 'Boards',
            'title' => 'Boards and mediums',
            'url' => '',
            'action' => '#boards-mediums',
            'haschildren' => false,
            'isactive' => false,
            'classes' => ['boc-primary-fragment'],
        ],
        [
            'key' => 'boc-fragment-grade-system',
            'text' => 'Grade System',
            'title' => 'Grade system',
            'url' => '',
            'action' => '#grade-system',

...
def add_macro_guide_sheet(xlsx_path: Path) -> None:
    ...
    rows = [
        ...
        ["Individual macros", "GenerateGradeSubjectMatrix, GenerateCategories, GenerateCourses, GenerateCoursesWithTemplateUpload, GenerateCohorts, GenerateGroups, GenerateCohortMembers, GenerateEnrolments, GenerateCourseTemplateApplication, GenerateCourseCertificates, GenerateCourseFinalExams, GenerateCourseTermExams, GenerateGradebookWeights, GenerateOptionalYearCategoryModel, GenerateStudentAcademicHistory, GenerateStudentPromotionPlan, GenerateAssessmentPlan, GenerateAttendancePolicy, GenerateNextYearCourses, GenerateNextYearCohorts, GenerateNextYearGroups, GenerateNextYearEnrolments, GenerateAlumniCohorts", ""],
        ["Derived target sheets", "13_grade_subject_matrix, 14_categories, 15_optional_year_category_model, 16_courses, 17_courses_with_templatecourse_, 18_cohorts, 19_groups, 26_cohort_members, 29_enrolments, 41_course_template_application, 55_student_academic_history_tem, 56_student_promotion_plan_2027_, 66_assessment_plan, 67_attendance_policy, 68_course_certificates, 69_course_final_exams, 70_course_term_exams, 72_gradebook_weights, 58_next_year_courses_2027_2028, 59_next_year_cohorts_2027_2028, 60_next_year_groups_2027_2028, 61_next_year_enrolments_2027_20, 62_alumni_cohorts_2027", ""],
